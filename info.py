...
API_ID = int(environ.get('API_ID', '20684219'))
API_HASH = environ.get('API_HASH', '4dce84937f3d2d9416770059df98cff0')
BOT_TOKEN = environ.get('BOT_TOKEN', "5349896012:AAENUUPdk52GatcbFZYZB2WaIiac2O0rwUs")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://te.legra.ph/file/cd8a9025743fbd00ea339.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2057115934').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001787446188').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vjmovierequest:vjmovierequest@cluster0.lthu1hh.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "TechVJv5Bot")
...
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001834678099))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'a21d381121da4bae1dd61d5c7dc7ae8de52e6041')
